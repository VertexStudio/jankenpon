...
echo "------------------------------------------------------------------------------"
echo "BEFORE"
cleos get table dealer player.rosa game
...
cleos push action dealer commit '["player.jose", "player.rosa", "'"$ROUND"'", "player.rosa", "'"$PLAYER_ROSA_COMMIT_ROUND"'"]' -p player.rosa
...
cleos push action dealer commit '["player.jose", "player.rosa", "'"$ROUND"'", "player.jose", "'"$PLAYER_JOSE_COMMIT_ROUND"'"]' -p player.jose

echo "------------------------------------------------------------------------------"
echo "player.rosa reveal"
cleos push action dealer reveal '["player.jose", "player.rosa", "'"$ROUND"'", "player.rosa", "'"$PLAYER_ROSA_SECRET_ROUND"'", "'"$PLAYER_ROSA_PLAYED_ROUND"'"]' -p player.rosa

echo "------------------------------------------------------------------------------"
echo "player.jose reveal"
cleos push action dealer reveal '["player.jose", "player.rosa", "'"$ROUND"'", "player.jose", "'"$PLAYER_JOSE_SECRET_ROUND"'", "'"$PLAYER_JOSE_PLAYED_ROUND"'"]' -p player.jose
